...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/BANGALORE-HOUSE-PRICE-PREDICTION/issues) interface to formally record security-related findings.
